...
$producto = "SELECT producto.codigo_pro, producto.nombre_pro, producto.stock, categoria.nombre FROM producto INNER JOIN categoria ON categoria.codigo_cat = producto.cat_copia";
?>
<!DOCTYPE html>
<html lang="en">
  <head>
          ...
          <div class="col-md-12 mb-3">
            <div class="card">
              <div class="card-header">
                <span><i class="bi bi-table me-2"></i></span> Tabla
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  ...
                  >
                    ...
                    <?php 
                    $consulta = mysqli_query($conn, $producto);
